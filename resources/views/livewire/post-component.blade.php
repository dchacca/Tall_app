...
<div class="antialiased sans-serif bg-gray-200 h-screen">
    ...
    <style>
        ...
        .form-checkbox {
            ...
            -webkit-post-select: none;
            -moz-post-select: none;
            -ms-post-select: none;
            post-select: none;
            flex-shrink: 0;
            color: currentColor;
                        ...
                        <td class="border-dashed border-t border-gray-200 px-3">
                            <label
                                ...
                                <input type="checkbox"
                                    ...
                                    :name="post.postId" @click="getRowDetail($event, post.postId)">
                            </label>
                        </td>
                        <td class="border-dashed border-t border-gray-200 postId">
                            <span class="text-gray-700 px-6 py-3 flex items-center"
                                x-text="post.id">{{$post->id}}</span>
                        </td>
                        <td class="border-dashed border-t border-gray-200 firstName">
                            <span class="text-gray-700 px-6 py-3 flex items-center"
                                x-text="post.title">{{$post->title}}</span>
                        </td>
